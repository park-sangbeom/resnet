...
def main(args):
    ...
    c_vector_lst1d = []
    json_path = "c_vector_1116_new.json"
    json_path_whiten1d = "c_vector_whiten1d_1116_new.json"    
    ...
    np.save("c_vector_arr1d_1116_new.npy",c_vector_arr1d)

    whitened1d, x_mean1d, x_std1d = whitening(c_vector_arr1d)
    np.save("x_mean1d_1116_new.npy", x_mean1d)
    np.save("x_std1d_1116_new.npy", x_std1d)
...
if __name__=="__main__":
    ...
    # LOAD WEIGHTS
    args.add_argument('--LOADWEIGHT', default='./weights/resnet1116_new/resnet_encoder90steps.pth', type=str,
